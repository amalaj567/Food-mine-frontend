      ...
      <div className={classes.content}>
        ...
        >
          ...
          <Input
            type="text"
            label="Name"
            {...register('name', { required: true, minLength: 5 ,  validate: value => value?.trim() !== '' || 'Name cannot be blank'})}
            error={errors.name}
          />
          ...
          <Input
            type="text"
            label="Origins"
            {...register('origins', { required: true ,   validate: value => value?.trim() !== '' || 'Origin cannot be blank'})}
          ...
          <Input
            ...
            {...register('cookTime', {
              required: true,
              validate: value => value?.trim() !== '' || 'Time cannot be blank',
            })}
