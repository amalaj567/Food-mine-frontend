    ...
    <div className={classes.container}>
      <div className={classes.content}>
        ...
        <form onSubmit={handleSubmit(submit)} noValidate>
          <Input
            label="Name"
            {...register('name', { required: true, minLength: 3,  validate: value => value.trim() !== '' || 'Name cannot be blank' })}
            error={errors.name}
          />
          <Input
            label="Email"
          ...
          <Input
            label="Address"
            {...register('address', { required: true, minLength: 5 ,  validate: value => value.trim() !== '' || 'Address cannot be blank'})}
